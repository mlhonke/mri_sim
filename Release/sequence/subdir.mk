...
sequence/%.o: ../sequence/%.cu
	...
	/usr/local/cuda-8.0/bin/nvcc -I/home/omega/Dev/external_sources/cub-1.5.2 -I"/home/omega/Dev/dSimL/acquisition" -I"/home/omega/Dev/dSimL/primitives" -I"/home/omega/Dev/dSimL/sequence" -I/usr/local/cuda/lib64/ -O3 -optf /home/omega/Dev/dSimL/nvcc_options -std=c++11 -gencode arch=compute_60,code=sm_60  -odir "sequence" -M -o "$(@:%.o=%.d)" "$<"
